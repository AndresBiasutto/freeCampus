...

{
  /* files.map((file) => (
              ...
              >
                ...
                >
                  <div className="h-28">
                    <div className="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-gradient-to-r from-sky-600 to-cyan-400 rounded-xl justify-items-center align-middle">
