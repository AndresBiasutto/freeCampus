...
const AsideBar = () => {
  ...
  return (
    <aside className=" z-50 ml-[-100%] fixed top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
      <div>
        ...
        <ul className="space-y-2 tracking-wide mt-8">
          ...
          <li>
            ...
            >
              ...
              <span className="group-hover:text-gray-700">Archivos</span>
            </Link>
          </li>
          <li>
            <Link
